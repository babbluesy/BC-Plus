        ...
        <div class="py-0 pl-3" style="width: 50%;">
          ...
          <div>
            ...
            <div v-else class="bg-transparent">
              ...
              >
                <q-carousel-slide :name="idx" v-for="(analysis, idx) in analysis_data.restaurant.rest_lst" :key="idx" class="column no-wrap p-1" style="overflow: hidden;">
                  <a :href="analysis.rest_url" :class="{ 'text-light': $q.dark.isActive }" style="text-decoration: none; color: black;">
                    <div class="row fit d-flex justify-start items-center no-wrap mx-0"> 
                      <q-img class="rounded-borders col-6 full-height" :src="analysis.img_path" style="width: 70px; height: 100px !important; overflow: hidden;" />
