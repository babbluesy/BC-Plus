<template>
  <div id="SA" class="container" :class="{ 'dark': goDark }">
    ...
    <div v-chat-scroll="{always: false, smooth : true}" class="bg-transparent message-box" style="height: 65vh;">
      <div id="messages">
            ...
            <div class="q-pa-md row justify-center">
              <div style="width: 100%; max-width: 180px" v-for="(chat, idx) in chattings" :key="idx">
